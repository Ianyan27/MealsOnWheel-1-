    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          <a class="nav-item nav-link active" href="{{ route('admin#index') }}">Home <span class="sr-only">(current)</span></a>
          <a class="nav-item nav-link active" href=" {{ route('admin#viewMeals') }}"> View Meals</a>
          <a class="nav-item nav-link active" href=" {{ route('admin#viewCustomers')}}">View Customers</a>
