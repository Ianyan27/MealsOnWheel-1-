...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body>
    <nav class="nav-bar">
      ...
      <button class="btn">
        <a class="btn btn-primary nav-item nav-link active" href="{{ route('caregiver#index') }}">Home <span class="sr-only">(current)</span></a>
      </button>
      <button class="btn">
        <a class="btn btn-primary nav-item nav-link active" href="{{ route('caregiver#addNewMeals') }}">Add Meal</a>
      </button>
      ...
      <div class="dropdown-menu p-3" aria-labelledby="navbarDropdownMenuLink">
        ...
        <a href="{{ route('caregiver#updateProfile', Auth()->user()->id) }}" 
