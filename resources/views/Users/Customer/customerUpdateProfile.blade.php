						...
						<div class=" animate-box">
							<div class="col-md-12 ">
                                ...
                                <form action="{{ route('customer#profileUpdated', $userData->id) }}" method="POST">
                                    ...
                                    <input name="age" class="input-md col-md-12" type="text" value="{{ old('age', $customerData->age) }}"/><br><br>
                                    ...
                                    <input name='phone_number' class="input-md col-md-12" type="text" value="{{ old('phone', $customerData->phone_number) }}"/><br><br>
