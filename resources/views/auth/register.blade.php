        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="customer box">
                <div class="mt-4">
                    ...
                    <x-input id="age" class="block mt-1 w-full" type="number" min="18" max="105"
                        name="age" autocomplete="age" />
                </div>
                <div class="mt-4">
                    <x-label for="disease" value="{{ __('Disease') }}" />
                    <x-input id="disease" class="block mt-1 w-full" type="text" name="disease"
                        autocomplete="disease" />
                </div>
                <div class="mt-4">
                    <x-label for="disability" value="{{ __('Disability') }}" />
                    <x-input id="disability" class="block mt-1 w-full" type="text" name="disability"
                ...
                <div class="mt-4">
                    ...
                    <x-input id="phone_number" class="block mt-1 w-full" type="tel"
                        pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="123-456-7890" name="phone_number"
